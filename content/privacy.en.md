...
- Ad impressions, clicks, and site usage information
...
For more information, see [How Google uses information from sites or apps that use its services](https://policies.google.com/technologies/partner-sites?hl=en).
...
The site operator does not directly store visitors' personal information in a separate database. Retention periods for information processed by third-party services may vary according to each provider's policies and the visitor's consent settings.

## Your Choices

Visitors can manage the use of cookies and advertising data by:
...
For questions about this privacy policy, please use the contact information available on the [GitHub profile](https://github.com/dadak797).

## Changes to This Policy

When this privacy policy changes, the updated content and effective date will be published on this page.
